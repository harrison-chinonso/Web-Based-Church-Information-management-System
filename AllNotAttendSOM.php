  ...
  <div class="card-panel mainwork">
    ...
    <form id="viewperson" class="new_register-content" name="viewperson">
       <div class="container" style="font-size:18px">
        <h1 style="font-size:30px" id='newreg'>View all School Of Ministry Under-Graduates</h1>
        <p style="font-size:20px" id="membernote">Search for all School Of Ministry Under-Graduates by:</p>
        <hr>   
        <div class="row">
