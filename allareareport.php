...
function showperson(value,name,id) {
    ...
    if (name ==="") {
        ...
        if (name === "areareport"){
        xmlhttp.open("GET","includes/loadTable.php?areareport="+document.viewperson.areareport.value,true);          
        }
        else if (name === "day"){
  ...
  <div class="card-panel mainwork">
    ...
    <form id="viewperson" class="new_register-content" name="viewperson">
       <div class="container" style="font-size:18px">
        <h1 style="font-size:30px" id='newreg'>View All Area Reports</h1>
        <p style="font-size:20px" id="membernote">Search for all Area Reports by:</p>
        <hr>
        <div class="row">
            <div class="worker input-field col m3 s12">
              <div class="row">
                    <div style="margin-top:25px" class="worker input-field col s12">
                            <button onclick ="showperson(this.value,this.name)" value="all" name="areareport" class="all">All</button>
                    </div>
                    <div style="margin-top:50px" class="col s12">
