...
<div id="workarea" class="col s12 m8 l10 ">
    <div class="card-panel mainwork">
        <div class="row">
            <div class="col s12">
                <?php $total = getTotalNewbeliever();
                $suftot = ($total != 1) ? 's' : '';
                ?>
                <h4 style="margin:1px 1px;">All New Believers</h4>
                <div style="margin:0px;" class="worker input-field col s9">
                    <h5>We Currently have <?php echo $total ?> registered New Believer<?php echo $suftot;?>.</h5>          
                </div> 
        ...
        <div id="new_register" class="new_register">
            <form id="viewperson" class="new_register-content" name="viewperson">
                <div class="container" style="font-size:18px;">
                    <p style="font-size:20px;" id="membernote">View New Believers by:</p>
                    <hr>
                    <div class="row"> 
                        <div class="col m2 s4">
                        ...
                        <div class="col m10 s8">
                            <div class="row">
                                <div class="worker input-field col m6 s10">
                            ...
                            <div class="row">
                                <div style="margin-top:5px" class="col m4 s10">
                                ...
                                <div style="margin-top:5px" class="col m4 s10">
                                        ...
                                        <input style="padding-left:35px"type="month" onchange="showperson(this.value,this.name)"  name="stmonth" placeholder="Enter Month and Year">
                                </div>
                                <div style="margin-top:5px" class="col m4 s10">     
