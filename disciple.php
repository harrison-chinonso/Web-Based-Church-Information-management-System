...
{ 
 $output = '';
 $query = "SELECT * FROM course_tb ORDER BY discipleship ASC";
 $statement = $link->prepare($query);
 $statement->execute();
 $result = $statement->fetchAll();
 foreach($result as $row)
 {
  $course = $row["discipleship"];
...
<div class="card-panel mainwork">
        <div class="row">
            <h4 align="center">Dominion City Academy (Discipleship Class)</h4>
            <hr>
            <div class="col m3 s5">
