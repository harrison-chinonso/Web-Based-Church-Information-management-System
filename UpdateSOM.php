...
<div id="workarea" class="col s12 m8 l10 ">
    ...
    <span class="black-text">
        <?php
            ...
            echo 'You\'ve Successfully Updated School Of Ministry Database';                
            }
        ...
        <form class="new_register-content" method="post" action="">
            <div class="container" style="font-size:18px">
                <h1 style="font-size:40px" id='newreg'>Update School Of Ministry</h1>
                <p style="font-size:20px" id="membernote">Please fill in this form to Update School Of Ministry Database</p>
                <hr>
                <div class="row">
