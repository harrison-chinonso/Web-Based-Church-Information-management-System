...
{ 
 $output = '';
 $query = "SELECT * FROM course_tb ORDER BY school_of_ministry ASC";
 $statement = $link->prepare($query);
 $statement->execute();
 $result = $statement->fetchAll();
 foreach($result as $row)
 {
  $course = $row["school_of_ministry"];
...
<div class="card-panel mainwork">
        <div class="row">
            <h4 align="center">Dominion City Academy (School Of Ministry)</h4>
            <hr>
            <div class="col m3 s5">
