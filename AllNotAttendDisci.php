  ...
  <div class="card-panel mainwork">
    ...
    <form id="viewperson" class="new_register-content" name="viewperson">
       <div class="container" style="font-size:18px">
        <h1 style="font-size:30px" id='newreg'>View all Discipleship Class Under-Gradutes</h1>
        <p style="font-size:20px" id="membernote">Search for all Discipleship Class Under-Gradutes by:</p>
        <hr>   
        <div class="row">
