...
function showperson(value,name,id) {
    ...
    if (name ==="") {
        ...
        xmlhttp.open("GET","includes/loadTable.php?mvp="+document.viewperson.mvp.value,true);          
        }
        else if (name === "return"){
        xmlhttp.open("GET","includes/loadTable.php?return="+document.viewperson.return.value,true);          
        }
        else if (name === "stday"){
  ...
  <div class="card-panel mainwork">
    ...
    <form id="viewperson" class="new_register-content" name="viewperson">
       <div class="container" style="font-size:18px">
        <h1 style="font-size:30px" id='newreg'>View All MVPs</h1>
        <p style="font-size:20px" id="membernote">Search for all MVPs by:</p>
        <hr>
        <div class="row">
            <div class="worker input-field col m3 s12">
              <div class="row">
                    <div style="margin-top:13px" class="worker input-field col m12 s12">
                            <button onclick ="showperson(this.value,this.name)" value="all" name="mvp" class="all">All</button>
                    </div>
                    <div style="margin-top:25.5px" class="worker input-field col m12 s12">
                            <button onclick ="showperson(this.value,this.name)" value="2ndtime" name="return" class="all">Returned</button>
                    </div>
                    <div style="margin-top:25.5px" class=" worker input-field col m12 s12">
