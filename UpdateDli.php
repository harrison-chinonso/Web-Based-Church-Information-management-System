    ...
    <span class="black-text">
        <?php
            if(isset ($_GET['success']) && empty ($_GET['success']) ){
                echo 'You\'ve Successfully Updated DLI Database';
            }
        ...
        <form class="new_register-content" method="post" action="">
            <div class="container" style="font-size:18px">
                <h1 style="font-size:40px" id='newreg'>Update DLI</h1>
                <p style="font-size:20px" id="membernote">Please fill in this form to Update DLI Database</p>
                <hr>
                <div class="row">
