  ...
  <div class="card-panel mainwork">
    ...
    <form id="viewperson" class="new_register-content" name="viewperson">
       <div class="container" style="font-size:18px">
        <h1 style="font-size:30px" id='newreg'>View all Encounter Attendant</h1>
        <p style="font-size:20px" id="membernote">Search for all Encounter Attendant by:</p>
        <hr>   
        <div class="row">
          ...
          <div class=" worker input-field col m3 s12">
            <?php $dept = getdept();?>
             <select onchange="showall(this.value,this.name)" class="browser-default" name="dept" required>
