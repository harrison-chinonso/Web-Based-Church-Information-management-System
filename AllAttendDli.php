  ...
  <div class="card-panel mainwork">
    ...
    <form id="viewperson" class="new_register-content" name="viewperson">
       <div class="container" style="font-size:18px">
        <h1 style="font-size:30px" id='newreg'>View all DLI Gradutes</h1>
        <p style="font-size:20px" id="membernote">Search for all DLI Graduates by:</p>
        <hr>   
        <div class="row">
          ...
          <div class="worker input-field col m3 s12">
                    <button onclick="showall(this.value,this.name)" value="all" name="showall" class="all">All</button>
          </div>
        </div>
      </div>
    </form>
